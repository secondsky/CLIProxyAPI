...
type ClaudeTokenStorage struct {
	...
	// AccountID is the Anthropic account identifier associated with this token.
...
func (ts *ClaudeTokenStorage) SaveTokenToFile(authFilePath string) error {
	...
	// Multi-account storage when we know the account id.
	if ts.AccountID != "" {
		return accounts.SaveProviderAccount("claude", ts.AccountID, func(existing map[string]any) map[string]any {
